...
import type { PlaceBarcodeDeps, PlaceImageDeps, PlaceSignatureDeps } from './placeImageTool.js';
import { placeBarcodeTool, placeImageTool, placeSignatureTool } from './placeImageTool.js';
