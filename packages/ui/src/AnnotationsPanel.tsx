...
import {
  ...
  ANNOTATIONS_KIND_MEASURE_AREA,
  ANNOTATIONS_KIND_MEASURE_DISTANCE,
  ANNOTATIONS_KIND_MEASURE_PERIMETER,
...
const KIND_LABELS: Record<PanelAnnotation['kind'], MessageKey> = {
  ...
  'measure-distance': ANNOTATIONS_KIND_MEASURE_DISTANCE,
  'measure-area': ANNOTATIONS_KIND_MEASURE_AREA,
  'measure-perimeter': ANNOTATIONS_KIND_MEASURE_PERIMETER,
